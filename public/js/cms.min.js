...
!function(a){a.fn.iframePostForm=function(b){var c,d,e,f,g=!0;return b=a.extend({},a.fn.iframePostForm.defaults,b),a("#"+b.iframeID).length||a("body").append('<iframe id="'+b.iframeID+'" name="'+b.iframeID+'" style="display:none" />'),a(this).each(function(){e=a(this),e.attr("target",b.iframeID),e.submit(function(){return g=b.post.apply(this),g===!1?g:(f=a("#"+b.iframeID).load(function(){c=f.contents().find("body"),d=b.json?a.parseJSON(c.text()):c.html(),b.complete.apply(this,[d]),f.unbind("load"),setTimeout(function(){c.html("")},1)}),void 0)})})},a.fn.iframePostForm.defaults={iframeID:"iframe-post-form",json:!1,post:function(){},complete:function(){}}}(jQuery);;
